  ...
  return (
    <div className="flex justify-center min-h-screen px-6 sm:px-16 bg-primary-img">
      <div className="flex justify-between items-center flex-col max-w-[1280px] w-full">
        ...
        <div className="flex flex-col items-center justify-start flex-1 w-full mt-2">
          <div className="flex justify-center w-full mt-10">
            <div className="relative md:max-w-[700px] md:min-w-[500px] min-w-full max-w-full p-[2px] rounded-3xl">
              <div className="w-full bg-purple-200 backdrop-blur-[4px] border border-black rounded-3xl shadow-card flex flex-col p-10">
                {wrongNetworkOpen ? (
                    ...
                    <div>
                      ...
                      >
                        <svg
                          ...
                          viewBox="0 0 384 512"
                          className="h-4 text-primary-green"
                        >
                          <path
                            fill="currentColor"
