      ...
      <div className="container-div">
        <div className="gradient-div" style={{ fontWeight: "bold" }}>
          {account ? (
            ...
            //     add
            //   </Link>{" "}
            //   liquidity to the ETH/NODT pool on Uniswap to get some.
            // </p>
            ...
            >
              Connect your wallet to provide liquidity and start earning NODT
              tokens
            </p>
          )}
        ...
        <div className="container-div2">
          <div className="connect-wallet-div">
            <p className="phnx-heading">AsNodt LP Staking</p>
            <p className="phnx-subheading">
              Stake ETH/NODT LP Tokens and earn <br />
              rewards in NODT
            </p>
                ...
                <Link to="/liquidity" style={{ textDecoration: "none" }}>
                  <Button
                    ...
                    style={{
                      ...
                      fontSize: "13px",
                      // backgroundColor: loading ? "#eee" : "#332545",
                    }}
                    // disabled={loading}
                    // onClick={_handleSupply}
                  >
                    Get NODT/ETH LP Token
                  </Button>
                </Link>
              </div>
            ) : (
