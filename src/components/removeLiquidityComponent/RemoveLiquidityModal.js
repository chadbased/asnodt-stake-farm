  ...
  return (
    <div className="rm-liq-div">
      <img
        ...
        src={Logo}
      ></img>
      <div className="rm-liq-heading">Remove NODT-ETH Liquidity</div>
      ...
      <div className="rm-liq-ps-div">
        <div
          className="rm-liq-ps"
          style={{
            backgroundColor: selectedPercentage === 25 ? "#332545" : "#f2f2fd",
        ...
        <div
          className="rm-liq-ps"
          style={{
            backgroundColor: selectedPercentage === 50 ? "#332545" : "#f2f2fd",
        ...
        <div
          className="rm-liq-ps"
          style={{
            backgroundColor: selectedPercentage === 75 ? "#332545" : "#f2f2fd",
        ...
        <div
          className="rm-liq-ps"
          style={{
            backgroundColor: selectedPercentage === 100 ? "#332545" : "#f2f2fd",
      ...
      <div className="rm-liq-phnx-eth-det-div">
        <div className="rm-liq-phnx-eth-det">
          ...
          <div className="rm-liq-phnx-eth-name">NODT</div>
      ...
      <div className="rm-liq-phnx-eth-con-div">
        <div className="rm-liq-phnx-eth-con">
          1 NODT = {ethPerPhnx + " "} ETH
        </div>
        <div className="rm-liq-phnx-eth-con">
          1 ETH = {phnxPerEth + " "} NODT
        </div>
      </div>
      ...
      {allowance == 0 ? (
        <button
          ...
          style={{ backgroundColor: approveStatus ? "#acacac" : "#332545" }}
          // onClick={() => setTxModalOpen()}
        >
          {approveStatus == false
            ? "Approve NODT-ETH LP"
            : "Approving NODT-ETH LP..."}
        </button>
      ...
      <div className="rm-liq-phnx-eth-lp-div">
        ...
        <img src={EthLogo}></img>
        <div className="rm-liq-phnx-eth-lp-sub">NODT/ETH LP</div>
        <div
      ...
      <div className="rm-liq-phnx-eth-lp-div">
        <div className="rm-liq-phnx-eth-lp-sub">Pooled NODT</div>
