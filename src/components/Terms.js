			...
			<Grid container className={classes.gridContainer}>
				...
				>
					...
					<h6 className={classes.definition}>
						<strong>
							{" "}
							NB: This product from AsNodt is
							...
							all legal jurisdiction across the world. AsNodt
					...
					<ul>
						...
						<li>
							<p>
								<strong>Website</strong> refers to AsNodt,
								accessible from{" "}
								<a
									href="http://www.asnodt.org/"
					...
					<p>
					NB: AsNodt suite of products are opensource/decentralized, meaning, that you’re responsible for whatever happens with its use.
					</p>
					<h3
					className={classes.sideMenuHeading}
						ref={(el) =>
