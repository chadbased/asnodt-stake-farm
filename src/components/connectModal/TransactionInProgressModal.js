          ...
          <div className="rm-liq-div">
            ...
            <div className="rm-liq-ps-div">
              <div
                ...
                style={{
                  backgroundColor:
                    selectedPercentage === 25 ? "#332545" : "#eee",
              ...
              <div
                ...
                style={{
                  backgroundColor:
                    selectedPercentage === 50 ? "#332545" : "#eee",
              ...
              <div
                ...
                style={{
                  backgroundColor:
                    selectedPercentage === 75 ? "#332545" : "#eee",
              ...
              <div
                ...
                style={{
                  backgroundColor:
                    selectedPercentage === 100 ? "#332545" : "#eee",
            ...
            <div className="rm-liq-phnx-eth-con-div">
              <div className="rm-liq-phnx-eth-con">1 NODT = 0.2335 ETH</div>
              <div className="rm-liq-phnx-eth-con">1 ETH = 0.3456665 NODT</div>
            </div>

            {allowance == 0 ? (
              <button className="rm-liq-btn">Approve NODT</button>
            ) : (
