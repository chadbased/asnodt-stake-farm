  ...
  return (
    <div>
      <div>
            ...
            {!removeLiquidity && (
              ...
              >
                <div className="displayFlex metamaskIconCenter">
                  <div>Add NODT/ETH-LP to Metamask </div>
                  <div>
        ...
        <div className="transaction-liq-phnx-eth-con">1 NODT = 0.2335 ETH</div>
        <div className="transaction-liq-phnx-eth-con">1 ETH = 0.3456665 NODT</div>
      </div> */}
