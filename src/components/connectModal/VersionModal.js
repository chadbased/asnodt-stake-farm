  ...
  return (
    <div>
      <div>
          ...
          <div className="version-div">
            ...
            {/* <div className="priceContainer">
              <div className="addPrice">
                <div className="displayFlex">
                  <div className="phnxDeposite">NODT Deposited</div>
        ...
        <div className="version-phnx-eth-con">1 NODT = 0.2335 ETH</div>
        <div className="version-phnx-eth-con">1 ETH = 0.3456665 NODT</div>
      </div> */}
            <a
