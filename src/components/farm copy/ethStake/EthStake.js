...
function EthStake({
  ...
  return (
    <div>
      <div className="farm-heading">ETH Stake</div>
      <div className="farm-sub-heading">Stake ETH to earn NODT</div>
      ...
      <div className="farm-details-div">
        <div className="farm-details-txt">
          <span style={{ color: "#332545" }}>ETH</span>{" "}
          <span style={{ color: "#4E4E55" }}>STAKED</span>
        </div>
        <div className="farm-details-txt-right">
      ...
      {web3context.active ? (
        allowance != 0 ? (
          ...
          <button
            ...
            style={{
              backgroundColor: approveStatus == false ? "#332545" : "#AAAAAA",
            }}
          >
      ...
      {showMore === false ? (
        ...
        <div>
          ...
          <div className="farm-details-div">
            <div className="farm-details-txt">Total ETH Staked</div>
