      ...
      <div className="flex flex-col items-center justify-start flex-1 w-full">
        <div className="flex justify-center w-full mt-10">
          <div className="relative md:max-w-[700px] md:min-w-[500px] min-w-full max-w-full p-[2px] rounded-3xl">
            <div className="w-full min-h-[400px] bg-purple-200 backdrop-blur-[4px] border border-black rounded-3xl shadow-card flex flex-col p-10">
              {wrongNetworkOpen ? (
                          ...
                          <div className="mx-auto">
                            {showLiquidityLoader ? (
                              ...
                              <span className="text-sm">
                                {formatBalance(tokensOut[0], "Asnodt-LP")}
                              </span>
                            )}
                          </div>
                        </div>
